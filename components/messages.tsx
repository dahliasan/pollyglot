...
export const AppMessage = ({ children, className, ...props }: MessageProps) => {
  return (
    <div
      ...
      {...props}
    >
      <div className='flex flex-col space-y-1 text-sm max-w-xs mx-2 order-2 items-start'>
        <div>
...
export const UserMessage = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className='flex flex-col space-y-1 text-sm max-w-xs mx-2 order-1 items-end'>
        <div>
